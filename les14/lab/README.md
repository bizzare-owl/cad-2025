...
## Цель работы
Освоить навыки работы со Spring Security
## Выполнение работы

Добавляем зависимость Spring Security
![1](img/img_3.png)

Настраиваем security фильтры и добавляем 2 пользователя
![1](img/img_2.png)

Обращаемся к эндпоинту открытому для manager (видим форму логина)
![1](img/img.png)
...
## Выводы
Научились использовать Spring Security для защиты Web приложений